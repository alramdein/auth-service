...
type AuthServiceClient interface {
	HasAccess(ctx context.Context, in *HassAccessRequest, opts ...grpc.CallOption) (*HasAccessResponse, error)
}
...
func (c *authServiceClient) HasAccess(ctx context.Context, in *HassAccessRequest, opts ...grpc.CallOption) (*HasAccessResponse, error) {
...
type AuthServiceServer interface {
	HasAccess(context.Context, *HassAccessRequest) (*HasAccessResponse, error)
...
func (UnimplementedAuthServiceServer) HasAccess(context.Context, *HassAccessRequest) (*HasAccessResponse, error) {
...
func _AuthService_HasAccess_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).HasAccess(ctx, req.(*HassAccessRequest))
	}
